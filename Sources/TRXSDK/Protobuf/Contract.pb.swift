...
public struct Protocol_AssetIssueContract {
    ...
    public var ownerAddress: Data {
        get {
            return _storage._ownerAddress
        }
        set {
            _uniqueStorage()._ownerAddress = newValue
        }
    }
    ...
    public var abbr: Data {
        get {
            return _storage._abbr
        }
        set {
            _uniqueStorage()._abbr = newValue
        }
    }
    ...
    public var totalSupply: Int64 {
        ...
        set {
            _uniqueStorage()._totalSupply = newValue
        }
    }
    ...
    public var trxNum: Int32 {
        get {
            return _storage._trxNum
        }
        set {
            _uniqueStorage()._trxNum = newValue
        }
    }

    public var num: Int32 {
        get {
            return _storage._num
        }
        set {
            _uniqueStorage()._num = newValue
        }
    }

    public var startTime: Int64 {
        get {
            return _storage._startTime
        }
        set {
            _uniqueStorage()._startTime = newValue
        }
    }

    public var endTime: Int64 {
        get {
            return _storage._endTime
        }
        set {
            _uniqueStorage()._endTime = newValue
        }
    }
    ...
    public var order: Int64 {
        get {
            return _storage._order
        }
        set {
            _uniqueStorage()._order = newValue
        }
    }

    public var voteScore: Int32 {
        get {
            return _storage._voteScore
        }
        set {
            _uniqueStorage()._voteScore = newValue
        }
    }
    ...
    public var url: Data {
        get {
            return _storage._url
        }
        set {
            _uniqueStorage()._url = newValue
        }
    }

    public var freeAssetNetLimit: Int64 {
        get {
            return _storage._freeAssetNetLimit
        }
        set {
            _uniqueStorage()._freeAssetNetLimit = newValue
        }
    }

    public var publicFreeAssetNetLimit: Int64 {
        get {
            return _storage._publicFreeAssetNetLimit
        }
        set {
            _uniqueStorage()._publicFreeAssetNetLimit = newValue
        }
    }

    public var publicFreeAssetNetUsage: Int64 {
        get {
            return _storage._publicFreeAssetNetUsage
        }
        set {
            _uniqueStorage()._publicFreeAssetNetUsage = newValue
        }
    }

    public var publicLatestFreeNetTime: Int64 {
        get {
            return _storage._publicLatestFreeNetTime
        }
        set {
            _uniqueStorage()._publicLatestFreeNetTime = newValue
        }
    }
...
public struct Protocol_CreateSmartContract {
    ...
    public var newContract: Protocol_SmartContract {
        get {
            return _storage._newContract ?? Protocol_SmartContract()
        }
        set {
            _uniqueStorage()._newContract = newValue
        }
    }
    /// Returns true if `newContract` has been explicitly set.
    public var hasNewContract: Bool {
        return _storage._newContract != nil
    }

    /// Clears the value of `newContract`. Subsequent reads from it will return its default value.
    public mutating func clearNewContract() {
        _uniqueStorage()._newContract = nil
    }
    ...
    public static func ==(lhs: Protocol_CreateSmartContract, rhs: Protocol_CreateSmartContract) -> Bool {
        if lhs._storage !== rhs._storage {
            let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
                ...
                if _storage._newContract != rhs_storage._newContract {
                    return false
                }
                return true
            }
