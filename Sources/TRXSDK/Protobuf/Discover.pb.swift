...
public struct Protocol_PingMessage {
    ...
    public var to: Protocol_Endpoint {
        get {
            return _storage._to ?? Protocol_Endpoint()
        }
        set {
            _uniqueStorage()._to = newValue
        }
    }
    /// Returns true if `to` has been explicitly set.
    public var hasTo: Bool {
        return _storage._to != nil
    }

    /// Clears the value of `to`. Subsequent reads from it will return its default value.
    public mutating func clearTo() {
        _uniqueStorage()._to = nil
    }
...
public struct Protocol_PongMessage {
    ...
    public var echo: Int32 {
        get {
            return _storage._echo
        }
        set {
            _uniqueStorage()._echo = newValue
        }
    }
...
public struct Protocol_FindNeighbours {
    ...
    public var targetID: Data {
        get {
            return _storage._targetID
        }
        set {
            _uniqueStorage()._targetID = newValue
        }
    }
...
public struct Protocol_Neighbours {
    ...
    public var neighbours: [Protocol_Endpoint] {
        get {
            return _storage._neighbours
        }
        set {
            _uniqueStorage()._neighbours = newValue
        }
    }
    ...
    public static func ==(lhs: Protocol_PingMessage, rhs: Protocol_PingMessage) -> Bool {
        if lhs._storage !== rhs._storage {
            let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
                ...
                if _storage._to != rhs_storage._to {
                    return false
                }
    ...
    public static func ==(lhs: Protocol_PongMessage, rhs: Protocol_PongMessage) -> Bool {
        if lhs._storage !== rhs._storage {
            let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
                ...
                if _storage._echo != rhs_storage._echo {
                    return false
                }
                if _storage._timestamp != rhs_storage._timestamp {
                    return false
    ...
    public static func ==(lhs: Protocol_FindNeighbours, rhs: Protocol_FindNeighbours) -> Bool {
        if lhs._storage !== rhs._storage {
            let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
                ...
                if _storage._targetID != rhs_storage._targetID {
                    return false
                }
                if _storage._timestamp != rhs_storage._timestamp {
                    return false
    ...
    public static func ==(lhs: Protocol_Neighbours, rhs: Protocol_Neighbours) -> Bool {
        if lhs._storage !== rhs._storage {
            let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
                ...
                if _storage._neighbours != rhs_storage._neighbours {
                    return false
                }
                if _storage._timestamp != rhs_storage._timestamp {
                    return false
